    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header header-elements-inline bg-danger">
                <h6 class="card-title font-weight-bold">Requirements</h6>
                {!! Qs::getPanelOptions() !!}
            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <select data-placeholder="Select" name="af[]" id="af" class="form-control select">
                                    <option value=""></option>
                                    @for($i=0; $i<=1; $i++)
                                    <option {{ (old('status') == 'Submitted') ? 'selected' : '' }} value="Submitted">Submitted</option>
                                    <option {{ (old('status') == 'Not_Submitted') ? 'selected' : '' }} value="Not Submitted">Not Submitted</option>
                                    @endfor
                                </select>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header header-elements-inline bg-success">
                <h6 class="card-title font-weight-bold">Medical Requirements</h6>
                {!! Qs::getPanelOptions() !!}
            </div>
