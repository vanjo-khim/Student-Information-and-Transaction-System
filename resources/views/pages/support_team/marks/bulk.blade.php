...
@section('page_title', 'Select Student Requirements')
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"><i class="icon-books mr-2"></i> Select Student Requirements</h5>
            {!! Qs::getPanelOptions() !!}
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="section_id" class="col-form-label font-weight-bold">Batch :</label>
                        ...
                        <div class="col-md-2 mt-4">
                            <div class="text-right mt-1">
                                <button type="submit" class="btn btn-primary">View Requirements <i class="icon-paperplane ml-2"></i></button>
                            </div>
                        </div>
