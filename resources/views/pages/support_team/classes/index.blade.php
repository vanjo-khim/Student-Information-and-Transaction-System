                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info border-0 alert-dismissible">
                                ...
                                <span>When a Class is created, a Batch will be automatically created for the Class, you can edit it or add more batch to the class at <a target="_blank" href="{{ route('sections.index') }}">Manage class</a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('classes.store') }}">
                                ...
                                <div class="form-group row">
                                    <label for="class_type_id" class="col-lg-3 col-form-label font-weight-semibold">Class Time</label>
                                    <div class="col-lg-9">
